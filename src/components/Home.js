      ...
      <div className="max-w-screen-lg h-full mx-auto my-auto ml-auto flex flex-col items-center justify-center p-4 md:flex-row text-white">
        <div className="flex flex-col justify-center h-full m-10">
          ...
          <p className="text-gray-500 py-4 text-left">
            Greetings! I'm Nishant Sahu, a 2019 graduate from Career College
            Barkatullah University Bhopal, with a degree of Computer Science &
            Passion for Web Development. I strive to create visually appealing
            and high-performing products that prioritize user experience &
